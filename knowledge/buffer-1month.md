...
- **Industry context** — Rentosertib Phase III: 320 patients, 47 centers China. Estimated primary completion Oct 2029, NDA Mar 2030. ISM6331 FDA Fast Track Designation (Jul 29). ISM8969 first-in-human dosing (Jun 2026). Insilico H1 2026 revenue ~$102.5-106.5M (~273-287% YoY). Zero FDA approvals yet despite ~$60B invested. EU AI Act high-risk provisions took effect Aug 2. >200 AI-designed drugs in clinical development. Phase I success 80-90%, Phase 2 only ~40% (comparable to historical). AI drug discovery H1 funding: $2.64B but 95% in two companies. AlphaFold 3 pipelines have now produced 4 Phase I clinical candidates (end-to-end AI-designed, under 14 months). 60% analyst probability first AI drug approved by 2027. AI compressing discovery-to-clinic from 4-6 years to as little as 18 months.
