...
- **2026-09-09** — Formation Bio "boring middle" thesis (Ehlers): excess of clinical-stage molecules stuck in enrollment/site-selection/protocol-amendment; AI value in development execution over molecule finding. Pipeline BLKR201/sprifermin/KMR301. https://www.labroots.com/trending/health-sciences-and-medical-research/30993/formation-bio-s-plan-ai-drug-discovery-2

- **2026-09-09** — Medidata/Pharmaphorum predictive trial design: Phase I→approval 6.7%, Phase III 5.9M data points (+283%/decade). Virtual twins + RWD external controls (up to 33% control-arm cut in neuro). Amendments as core delay driver now scenario-modelled pre-enrollment. https://pharmaphorum.com/digital/ai-clinical-trials-building-better-trials-they-start
...
- **Industry context** — Rentosertib Phase III NOT_YET_RECRUITING as of Sep 5. Insilico first AI drug profitability ($106.3M H1 2026). Total 2026 deal value ~$7.3B. 33+ PCCs. >200 AI drugs in clinical development. H1 AI drug discovery funding $2.64B but 95% in Isomorphic+Chai. BioXcel bankruptcy. ArsenalBio + TScan pivot to in vivo cell therapy. AI clinical operations layer crystallizing (CluePoints, IQVIA, Castor, Weave Bio, Faro, Formation "boring middle", Medidata virtual twins, Forus $150M access network). Sovereign/open-source compute wave (SK Biopharm 128 B200s, JapanFold on Tenstorrent, K-Fold). Benchling 2026: 76% adoption literature review, 71% protein structure, 50% faster time-to-target.
