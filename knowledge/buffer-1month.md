...
- **2026-08-21** — MIT Technology Review investigates AI drug patent inventorship problem (Aug 21). Insilico claimed rentosertib was "discovered by" its AI platform in press releases but named five humans as inventors on the patent. US courts (DABUS, 2022) ruled only humans can be inventors. USPTO under Trump treats AI as a tool — no need to mention it. Abbott warns incorrect inventor listing could invalidate patents. Isomorphic Labs' Korman: "our laws will need to evolve." Companies keeping humans in loop and documenting carefully for now. https://www.technologyreview.com/2026/08/21/1142627/when-ai-designs-a-drug-who-gets-the-credit/

- **2026-08-18** — Enveda ENV-308 Phase 1 positive (Aug 18): first pill designed from chemistry of exercise. Mimics Lac-Phe hormone. 88 healthy volunteers, exceptional safety, no serious AEs, excellent GI safety (critical for GLP-1 adjacent therapy). Reduced leptin. Animal data: preserved lean muscle, prevented weight regain after stopping therapy. Phase 2 planned for post-GLP-1 weight maintenance. AI-discovered molecule. https://www.biospace.com/press-releases/enveda-reports-positive-phase-1-results-for-env-308-the-first-pill-designed-from-the-chemistry-of-exercise
...
- **2026-08-04** — Nature Reviews Drug Discovery: designing small-molecule binding proteins (Aug 4). NISE method (Nature, Jun 2026) achieves zero-shot design of drug-binding proteins. 100% success on exatecan, 83% on apixaban, Kd = 80 pM. Proteins that bind drug molecules from scratch — implications for drug delivery and biosensing. https://www.nature.com/articles/d41573-026-00129-y

- **2026-07-23** — Northwestern DREAM Cloud Lab: NSF awards $20M for AI protein engineering hub (Jul 23). Nation's first publicly accessible, AI-powered cloud laboratory for protein engineering. Part of $380M national PCL network (20 test beds). Will synthesize 300,000+ proteins, generate ~30M data points over 4 years. Data and AI models released open-access. Cell-free protein synthesis. Part of U.S. Genesis Mission for AI-driven scientific discovery. https://news.northwestern.edu/stories/2026/07/ai-directed-protein-engineering-cloud-lab-receives-20-million-from-nsf
...
- **2026-08-20** — Sravathi AI + Mayo Clinic: AI targets "undruggable" GIPC1 protein (Aug 20). Bengaluru startup + Mayo used generative AI + physics-based chemistry to screen ~40K compounds. Lab/animal models: slowed tumor progression, improved survival, enhanced gemcitabine effect in pancreatic cancer. First AI-targeted therapy against GIPC1 PDZ-domain. Further safety testing needed. https://pharma.economictimes.indiatimes.com/news/pharma-industry/sravathi-ai-mayo-clinic-develop-new-molecule-against-undruggable-cancer-target/133362018

- **2026-08-14** — Artera DIRECT-AI: First patient enrolled in nationwide AI prostate cancer registry (Aug 14). ArteraAI Protest Test uses multimodal AI on histopathology + clinical data for prognostic + predictive insights. Non-interventional registry testing whether AI diagnostic tools change real-world clinical behavior, not just accuracy. https://www.biospace.com/press-releases/artera-enrolls-first-patient-in-direct-ai-registry-marking-milestone-in-real-world-evidence-generation-for-ai-powered-prostate-cancer-care
...
- **2026-08-20** — Chai Discovery $400M Series C (Jul 14). ~$1.3B valuation. Chai-2 ~20% zero-shot antibody hit rates. Now 5 major pharma partnerships: Novartis, Pfizer, Lilly, argenx, BMS. https://www.chaidiscovery.com/news
...
- **2026-06-03** — Alnylam-Inceptive $2B AI-RNA collaboration (Jun 3). Up to $2B value, $30M upfront (cash + equity). Three-year collaboration applying Inceptive's generative AI foundation models to RNAi therapeutic discovery. Inceptive led by Jakob Uszkoreit (co-author of "Attention Is All You Need"). Pairs Alnylam's 20+ years proprietary RNAi data with Inceptive's transformer-architecture models for siRNA design. First deal applying transformer AI to siRNA design at this scale. Signals AI expanding beyond small molecules and antibodies into nucleic acid therapeutics. https://investors.alnylam.com/press-release?id=29941

- **Industry context** — Rentosertib Phase III initiated Jul 7 (NCT07687459): 320 patients, 47 centers China, not yet recruiting as of Aug 2026. Phase IIa showed +98.4 mL FVC (60 mg QD) vs -20.3 mL placebo at 12 weeks. ISM6331 FDA Fast Track Designation (Jul 29). ISM8969 first-in-human dosing (Jun 2026). Insilico H1 2026 revenue ~$102.5-106.5M (~273-287% YoY). Zero FDA approvals yet despite ~$60B invested. EU AI Act high-risk provisions took effect Aug 2. >200 AI-designed drugs in clinical development. Phase I success 80-90%, Phase 2 only ~40% (comparable to historical). AI drug discovery H1 funding: $2.64B but 95% in two companies. AlphaFold 3 pipelines have now produced 4 Phase I clinical candidates (end-to-end AI-designed, under 14 months). 60% analyst probability first AI drug approved by 2027. AI compressing discovery-to-clinic from 4-6 years to as little as 18 months. Anthropic acquired Coefficient Bio ($400M, Apr 2026) — biology-native AI team from Genentech Prescient Design. Isomorphic Labs still no disclosed clinical candidate despite $2.1B raise.
