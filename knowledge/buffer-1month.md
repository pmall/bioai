...
- **Industry context** — Rentosertib Phase III NOT_YET_RECRUITING as of Sep 5. Insilico first AI drug profitability ($106.3M H1 2026). Total 2026 deal value ~$7.3B. 33+ PCCs. >200 AI drugs in clinical development. H1 AI drug discovery funding $2.64B but 95% in Isomorphic+Chai. BioXcel bankruptcy. ArsenalBio + TScan pivot to in vivo cell therapy. Benchling 2026 Biotech AI Report: 76% adoption for literature review, 71% for protein structure, 50% faster time-to-target. AI clinical operations layer crystallizing (CluePoints, IQVIA, Castor, Weave Bio). Wet-lab infrastructure boom (Adaptyv $40M, Transfyr $25M). Family office capital surging (Bezos/Gates → LifeMine $188M). FDA building QMIN for digital-twin-augmented trials. Claude protein design variance analysis shows high average + enormous variance + uncalibrated self-assessment.
