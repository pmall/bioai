...
- **2026-05** — ESMFold2 / ESM Atlas (CZ Biohub, May 2026): Open-source protein structure prediction model surpassing AlphaFold3. Atlas of 1.1B predicted structures + 6.8B sequences. MIT-licensed with no commercial restrictions. Includes validated binder design protocol. Outperforms AF3 on antibody-antigen complex prediction. Signals that open-source models can match or exceed proprietary alternatives. https://www.nature.com/articles/d41586-026-01686-3

- **2026-03** — VibeGen (MIT Buehler lab, Matter): AI model designing proteins by their dynamics — vibration, flexing, shape-shifting — rather than static structure. Uses diffusion model with designer/predictor agent pair. Demonstrates functional degeneracy: many different sequences and folds can satisfy the same vibrational target. Opens a new design frontier beyond structure-based protein engineering. https://news.mit.edu/2026/mit-engineers-design-proteins-by-motion-not-just-shape-0326

- **2026-07** — Verseon Deep Quantum Modeling: Physics-first drug design builds molecules atom-by-atom from protein pocket using quantum calculations. AI enters only after synthesis/testing for variation. CEO argues AI is "good at interpolation and terrible at extrapolation." Novel chemotypes across 7 programs (anticoagulants, diabetic eye disease, cancer). https://www.drugdiscoverytrends.com/verseon-bets-physics-can-take-drug-design-beyond-ais-training-data/
